...
public interface Constants {
     ...
     * Fred constants
     */
    String FRED_KEY_FIELD_LEVEL_ONE = "FRED_KEY_FIELD_LEVEL_ONE";
    String FRED_KEY_FIELD_LEVEL_TWO = "FRED_KEY_FIELD_LEVEL_TWO";
    String FRED_KEY_FIELD_LEVEL_THREE = "FRED_KEY_FIELD_LEVEL_THREE";
    String PREFS_KEY_FRED_POINTS_VISIBLE = "PREFS_KEY_FRED_POINTS_VISIBLE";
