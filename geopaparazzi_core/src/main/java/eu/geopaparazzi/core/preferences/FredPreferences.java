...
//     */
//    public FredPreferences(Context ctxt, AttributeSet attrs ) {
//        super(ctxt, attrs);
//        this.context = ctxt;
...
//    }
    ...
    public void changeSettings(String quicksetChoice, Context context){
        ...
        if (quicksetChoice.equals("fredSurveysite")) { //$NON-NLS-1$
            ...
            parentTable = context.getString(R.string.fred_defval_first_level_table);
            parentID = context.getString(R.string.fred_defval_first_level_ID);
            parentDescriptorField = context.getString(R.string.fred_defval_first_level_descriptor);
            parentTimeStamp = context.getString(R.string.fred_defval_first_level_timestamp);
            childTable = context.getString(R.string.fred_defval_second_level_table);
            childID = context.getString(R.string.fred_defval_second_level_ID);
            colLat = context.getString(R.string.fred_defval_column_Lat);
            colLon = context.getString(R.string.fred_defval_column_Lon);
            ...
            haveParentTable = Boolean.valueOf(context.getString(R.string.fred_BotZoo_two_levels));
            parentTable = context.getString(R.string.fred_BotZoo_first_level_table);
            parentID = context.getString(R.string.fred_BotZoo_first_level_ID);
            parentDescriptorField = context.getString(R.string.fred_BotZoo_first_level_descriptor);
            parentTimeStamp = context.getString(R.string.fred_BotZoo_first_level_timestamp);
            childTable = context.getString(R.string.fred_BotZoo_second_level_table);
            childID = context.getString(R.string.fred_BotZoo_second_level_ID);
            colLat = context.getString(R.string.fred_BotZoo_column_Lat);
            colLon = context.getString(R.string.fred_BotZoo_column_Lon);
